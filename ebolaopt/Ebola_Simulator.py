...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1296, 526)
        MainWindow.setMinimumSize(QtCore.QSize(1296, 500))
        MainWindow.setMaximumSize(QtCore.QSize(1296, 526))
        ...
        self.formLayout_4.setLayout(0, QtGui.QFormLayout.LabelRole, self.horizontalLayout_2)
        ...
        self.formLayout_4.setLayout(1, QtGui.QFormLayout.LabelRole, self.horizontalLayout_3)
        ...
        self.formLayout_4.setLayout(2, QtGui.QFormLayout.LabelRole, self.horizontalLayout_4)
        ...
        self.formLayout_4.setLayout(3, QtGui.QFormLayout.LabelRole, self.horizontalLayout_5)
        ...
        self.formLayout_4.setLayout(4, QtGui.QFormLayout.LabelRole, self.horizontalLayout_6)
	...
	def openFileDialog_Data():
		...
		path = str(QtGui.QFileDialog.getOpenFileName(MainWindow,"Open File", "directory/","CSV (*.csv *.CSV)"))
	...
	def Ebola_Simulator():  
		...
		print [N_samples, t_final, I_init, trajectories, n_threads, N, valid_interventions, country, constraints_file, data_file]

		#alloc, cost = optimize(N=N,N_samples=N_samples, t_final=t_final, I_init=I_init, trajectories=trajectories,\
		#valid_interventions=valid_interventions, country=country, constraints_file=constraints_file, data_file=data_file, n_threads=n_threads)
		
        self.retranslateUi(MainWindow)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Ebola_Simulator)
        QtCore.QObject.connect(self.checkBox_2, QtCore.SIGNAL(_fromUtf8("clicked()")), self.label_6.update)
        QtCore.QObject.connect(self.checkBox_3, QtCore.SIGNAL(_fromUtf8("clicked()")), self.lineEdit_6.update)
        QtCore.QObject.connect(self.checkBox, QtCore.SIGNAL(_fromUtf8("clicked()")), self.lineEdit_6.update)
        ...
        QtCore.QObject.connect(self.actionImport_Constraints_File, QtCore.SIGNAL(_fromUtf8("activated()")), openFileDialog_Constraints)
        QtCore.QObject.connect(self.actionImport_Data_File, QtCore.SIGNAL(_fromUtf8("activated()")), openFileDialog_Data)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "valid_int", None))
